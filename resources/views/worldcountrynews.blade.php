...
<title>Latest News from {{ $country }}</title>
  ...
  <div class="row">
    <div class="col-sm-2">
      <div class="list-group list-group-flush">
          ...
          <p class="list-group-item list-group-item-action bg-light"> {{ $country }}</p>
      </div>
    </div>
    <div class="col-sm-8">
      <h4>You are Reading Latest News From {{ $country }}</h4>
      @foreach($countrynews as $news)
      <div class="well">
          <div class="media">
