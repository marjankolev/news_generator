...
<title>WallStreet Latest News</title>
      ...
      <div class="row">
          <div class="col-sm-2">
            <div class="list-group list-group-flush">
              <form method="POST" action="/walstreet">
                @csrf
                <h4>Sort By:</h4>
                <div class="radio">
                  <label><input type="radio" name="filter" value="publishedAt">Published At</label>
                </div>
                <div class="radio">
                  <label><input type="radio" name="filter" value="popularity">Popularity</label>
                </div>
                <div class="radio">
                  <label><input type="radio" name="filter" value="relevancy">Relevancy</label>
                </div>
